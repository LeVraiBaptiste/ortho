...
const BUBBLE_BASE_RADIUS = 8
const BUBBLE_VOLUME_SCALE = 35
const BUBBLE_RISE_SPEED = -2.2
const BUBBLE_FADE_RATE = 0.008
const CREATURE_FADE_ALPHA = 0.06
const PEBBLE_COUNT = 20
const VOICE_PRESENCE_ATTACK = 0.08  // ~200ms to full presence
const VOICE_PRESENCE_DECAY = 0.06   // ~270ms fade out
